...
namespace App\Libraries\PhpPresentation\Reader;

use Exception;
use App\Libraries\Common\Microsoft\OLERead;
use App\Libraries\Common\Text;
use App\Libraries\PhpPresentation\AbstractShape;
use App\Libraries\PhpPresentation\Exception\FeatureNotImplementedException;
...
use App\Libraries\PhpPresentation\Shape;
use App\Libraries\PhpPresentation\Shape\Drawing;
...
class PowerPoint97 implements ReaderInterface
{
    ...
    /**
     * Can the current \App\Libraries\PhpPresentation\Reader\ReaderInterface read the file?
     */
            ...
            foreach ($officeArtFOPTE as $opt) {
                ...
                switch ($opt['opid']) {
                    ...
                    case 0x0081:
                        ...
                        $arrayReturn['insetLeft'] = \App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']);
                        break;
                    case 0x0082:
                        // Text : dyTextTop
                        //@link : http://msdn.microsoft.com/en-us/library/dd925068(v=office.12).aspx
                        $arrayReturn['insetTop'] = \App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']);
                        break;
                    case 0x0083:
                        // Text : dxTextRight
                        //@link : http://msdn.microsoft.com/en-us/library/dd906782(v=office.12).aspx
                        $arrayReturn['insetRight'] = \App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']);
                        break;
                    case 0x0084:
                        // Text : dyTextBottom
                        //@link : http://msdn.microsoft.com/en-us/library/dd772858(v=office.12).aspx
                        $arrayReturn['insetBottom'] = \App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']);
                        break;
                    case 0x0085:
                        // Text : WrapText
                    ...
                    case 0x0193:
                        ...
                        // echo 'fillRectRight  : '.\App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']).EOL;
                        break;
                    case 0x0194:
                        // Fill : fillRectBottom
                        //@link : http://msdn.microsoft.com/en-us/library/dd910194(v=office.12).aspx
                        // echo 'fillRectBottom   : '.\App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']).EOL;
                        break;
                    case 0x01BF:
                    ...
                    case 0x01CB:
                        ...
                        $arrayReturn['lineWidth'] = \App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']);
                        break;
                    case 0x01D6:
                    ...
                    case 0x0205:
                        ...
                        $arrayReturn['shadowOffsetX'] = \App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']);
                        break;
                    case 0x0206:
                        // Shadow Style : shadowOffsetY
                        //@link : http://msdn.microsoft.com/en-us/library/dd907855(v=office.12).aspx
                        $arrayReturn['shadowOffsetY'] = \App\Libraries\Common\Drawing::emuToPixels((int) $opt['op']);
                        break;
                    case 0x023F:
