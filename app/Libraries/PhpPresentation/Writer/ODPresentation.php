...
use App\Libraries\Common\Adapter\Zip\ZipArchiveAdapter;
use App\Libraries\PhpPresentation\Exception\DirectoryNotFoundException;
use App\Libraries\PhpPresentation\Exception\FileCopyException;
use App\Libraries\PhpPresentation\Exception\FileRemoveException;
use App\Libraries\PhpPresentation\Exception\InvalidParameterException;
...
{
    /**
     * @var \App\Libraries\PhpPresentation\Shape\Chart[]
     */
    public $chartArray = [];
    ...
    /**
     * Create a new \App\Libraries\PhpPresentation\Writer\ODPresentation.
     *
    ...
    public function save(string $pFilename): void
    {
        ...
        foreach ($oDir as $oFile) {
            ...
            if ($class->isAbstract() || !$class->isSubclassOf('App\Libraries\PhpPresentation\Writer\ODPresentation\AbstractDecoratorWriter')) {
                continue;
            }
     ...
     *
     * @return \App\Libraries\PhpPresentation\Writer\ODPresentation
     */
